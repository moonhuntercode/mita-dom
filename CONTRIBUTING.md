# 🛠️ Guía de Mantenimiento y Contribución (MitaDOM)

¡Bienvenido al ciclo de vida de MitaDOM! Esta guía está diseñada para los mantenedores del proyecto y cualquier desarrollador de la comunidad que desee aportar mejoras a la librería o publicar nuevas versiones oficiales en NPM.
...
Todo el código fuente y la magia de MitaDOM vive en la carpeta `src/`. 
