...
## La Misión
1. **Zero Dependencies**: El Core de MitaDOM no depende de ninguna otra librería. Lo que instalas es exactamente el código que ves.
...
3. **Curva de Aprendizaje Plana**: Si sabes JavaScript moderno y HTML, ya sabes usar MitaDOM. No hay sintaxis inventada (JSX obligatorio) ni lenguajes intermedios.
